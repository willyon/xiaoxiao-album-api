...
-- ============================================
-- 步骤 2：重建 cleanup_group_members 表（删除 sharpness_score）
-- ============================================

-- 2.1 创建新表（不包含 sharpness_score）
CREATE TABLE IF NOT EXISTS cleanup_group_members_new (
...
-- ============================================
-- 步骤 3：重建 images 表（删除 sharpness_score，保留 is_blurry 和 blurry_probability）
-- ============================================

-- 3.1 创建新表（不包含 sharpness_score，但保留 is_blurry 和 blurry_probability）
...
-- 3.2 复制数据（排除 sharpness_score，保留其他所有字段包括 is_blurry 和 blurry_probability）
