/*
 * @Description: 从 media_search / media_search_fts 中移除 location_text，重建相关表
...
async function migrateRemoveLocationFromSearch() {
  console.log("🚀 开始迁移：移除 media_search / media_search_fts 中的 location_text...");
  ...
  console.log("   ✅ 已删除 FTS 虚拟表（media_fts / media_search_fts）");
